...
_SHARED_RULES = (
    ...
    "- The context may include a 'daily_review' block (yesterday's SPY-relative result, what worked/failed, "
    "avoid_next_cycle, current mode, symbols to watch, reduce_churn). Use it to avoid repeating mistakes and "
    "to reduce churn when advised. It is research feedback only and never authorizes bypassing risk.\n"
