...
Runtime artifacts under `data/experiments`, `data/reports`, and local database files under `data/` are ignored outputs. They are generated by local runs and are not committed project evidence.
